...
description: "我第一次看 Cloudflare Workers AI 的计费时，就有一个疑问：每天送的 10,000 neurons 到底值多少钱？根据 Cloudflare 官方定价页，Workers AI 的价格是 $0.011 / 1,000 neurons，并且免费额度是 每天 10,000 neurons，每天 00:00 UTC 重置。所以换算下来就是：10,000 / 1,000 × $0.011 = $0.11也就是说，Work..."
