...
description: "前言开发 Pixiv 爬虫的过程中，我深入研究了 Pixiv 的各种 API 接口。本文将基于实际的爬虫实现，详细介绍 Pixiv 的主要 API 接口、请求格式以及返回数据结构，希望能为其他开发者提供参考。前阵子开发了一个serverless的pixiv爬虫：Pixiv爬虫/下载/代理，无需服务器即可一键部署！使用示例项目地址：https://github.com/evepupil/serverless_pixiv_crawle..."
...
![v2-3052331952cbe0c11d5404c6d4b7ff26_r.jpg](/images/notion/pixiv-api-2a94342e/image-1.jpg)
