...
description: "反向代理就是代替你访问目标网站，然后把结果返回给你。比如你想访问 example.com，但你不想直接访问，而是通过 Cloudflare Worker 去访问，然后 Workers 再把内容返回给你。"
published: "2025-11-17"
locale: "zh-CN"
tags: ["Cloudflare", "好玩", "serverless"]
draft: false
pinned: false
image: "/images/posts/cloudflare-worker反向代理网站教程/cover.jpg"
