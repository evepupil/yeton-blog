...
description: "前言在搭建 Pixiv 爬虫镜像站或其他代理服务时，我们常利用 Cloudflare Worker 作为边缘网关。然而，当你尝试在 Worker 中直接 fetch('http://你的服务器IP') 时，经常会遇到一个诡异的 403 Forbidden 报错。最让人困惑的是：本地测试全通：用浏览器或 Postman 直连服务器 IP，一切正常。服务器防火墙全开：甚至设置了 Allow All 依然被拒。响应极快：Worker 日..."
